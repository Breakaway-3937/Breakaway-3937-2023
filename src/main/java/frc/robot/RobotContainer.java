...
public class RobotContainer {
  ...
  private final JoystickButton aButton = new JoystickButton(xboxController, Constants.Controllers.XBOX_CONTROLLER_A_BUTTON);
  private final JoystickButton bButton = new JoystickButton(xboxController, Constants.Controllers.XBOX_CONTROLLER_B_BUTTON);
  private final JoystickButton xButton = new JoystickButton(xboxController, Constants.Controllers.XBOX_CONTROLLER_X_BUTTON);
  private final JoystickButton yButton = new JoystickButton(xboxController, Constants.Controllers.XBOX_CONTROLLER_Y_BUTTON);
  ...
  private void configureButtonBindings() {
    ...
    midLeft.onTrue(new InstantCommand(() -> s_Photon.setMidLeft()).alongWith(new InstantCommand(() -> c_RunArm.setFlag1False())));
    midRight.onTrue(new InstantCommand(() -> s_Photon.setMidRight()).alongWith(new InstantCommand(() -> c_RunArm.setFlag1False())));
    midMid.onTrue(new InstantCommand(() -> s_Photon.setMidMid()).alongWith(new InstantCommand(() -> c_RunArm.setFlag1False())));
    hybridMid.onTrue(new InstantCommand(() -> s_Photon.setHybridMid()).alongWith(new InstantCommand(() -> c_RunArm.setFlag1False())));
    hybridRight.onTrue(new InstantCommand(() -> s_Photon.setHybridRight()).alongWith(new InstantCommand(() -> c_RunArm.setFlag1False())));
    hybridLeft.onTrue(new InstantCommand(() -> s_Photon.setHybridLeft()).alongWith(new InstantCommand(() -> c_RunArm.setFlag1False())));
    aButton.onTrue(new InstantCommand(() -> c_RunArm.setFlag1False()));
    bButton.onTrue(new InstantCommand(() -> c_RunArm.setFlag1False()));
    xButton.onTrue(new InstantCommand(() -> c_RunArm.setFlag1False()));
    yButton.onTrue(new InstantCommand(() -> c_RunArm.setFlag1False()));
